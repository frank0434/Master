...
source(here::here("02Scripts/R/EditApsimx.R"))
```
...
apsimx_flag <- "/Edit"
apsimx_file <- "C:/Data/Master/03processed-data/apsimxFiles/ModifiedSKL_0.06AshleyDeneSD2.apsimx"
...
# KL_layers = 22
slurpnodes = c("[SlurpSowingRule].Script.SKL = ",
...
```{r}
apsimx_sims_dir
apsimxs = list.files(apsimx_sims_dir, pattern = ".apsimx$")
