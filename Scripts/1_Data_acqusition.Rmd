...
Iversen12 <- read_met(here::here("Data/ClimateAndObserved/lincoln.met"), skip_unit =  7, skip_meta = 6)
head(Iversen12)

AshleyDene <- read_met(here::here("Data/ClimateAndObserved/AshleyDene.met"), skip_unit = 10, skip_meta = 8)
