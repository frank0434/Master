...
```{python}
# Test
CoverDF.loc[CoverDF.SowingDate == 'SD1', ['Date', 'LightInterception']].to_csv('./03processed-data/CoverDataSD1.csv',index = False)
```
...
for i in SDs:
    CoverDF.loc[CoverDF.SowingDate == i,
                ['Date', 'LightInterception']].to_csv('./03processed-data/CoverDataAshleyDene' + i + '.csv',index = False)
```
...
for i in SDs:
    CoverDFI12.loc[CoverDFI12['SowingDate'] == i, 
                   ['Clock.Today', 'LightInterception']].to_csv('./03processed-data/CoverDataIversen12' + i + '.csv',
                                                 index = False)
```
...
for i in SDs:
    CoverDF.loc[CoverDF.SowingDate == i,
                ['Date', 'LightInterception','k']].to_csv('./03processed-data/CoverDataAshleyDene' + i + '.csv',index = False)
```
