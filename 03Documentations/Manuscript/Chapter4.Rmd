...
DUL_LL_range$SowingDate <- as.factor(DUL_LL_range$SowingDate)

DUL_LL_range$SowingDate <-  factor(DUL_LL_range$SowingDate,
                                   levels = levels(DUL_LL_range$SowingDate)[c(1, 3:10, 2)])
p_DUL_LL <- DUL_LL_range %>% 
  ...
  theme_water() +
  scale_color_manual(name = "", values = c("#FF0000", "#0000FF"))
