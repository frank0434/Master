...
ggsave("Figures/timecost.png", width = 10, height =6, dpi = 320)
...
ggsave("Figures/LAIinterp.png", width = 10, height = 14, dpi = 320)
...
ggsave("Figures/bestfits.png", width = 10, height =6, dpi = 320)
...
DT_sub %>% 
  ...
  labs(y = paste0(gsub("Predicted\\.|mm", "", pre_col), " (mm)"), 
       x = "Date") +
  scale_colour_manual(name = "col", values = timestep_colors, labels = timestep_labels)
ggsave("Figures/LAI_timecourse.png", width = 7, height =10, dpi = 320)
...
ggsave("Figures/LAI_preobs.png",plot = p, width = 10, height =5, dpi = 320)
```
...
DT_sub%>% 
  ...
  labs(y = paste0(gsub("Predicted\\.|mm", "", pre_col), " (mm)"), 
       x = "Date") +
  scale_colour_manual(name = "col", values = timestep_colors, labels = timestep_labels)
ggsave("Figures/LeafWt_timecourse.png", width = 7, height =10, dpi = 320)
