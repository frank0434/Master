...
# Forming a function
```{r}
estimate_DUL <- function(DT, sowingdate, layer){
...
estimates %>% 
  ...
  geom_smooth(aes(y = DUL, color = "DUL")) +
  geom_point(aes(y = posterior_DUL, color = "POSTDUL")) + 
  geom_smooth(aes(y = posterior_DUL, color = "POSTDUL")) +
  coord_flip()+
