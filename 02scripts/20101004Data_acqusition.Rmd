...
```{r richard}
path_richard = "c:/Users/Administrator/Dropbox/Data/APSIM_Sim.xlsx"
...
# change to NZ time zone 
dt[, (col_date) := lapply(.SD, function(x) as.Date(x, tz = "Pacific/Auckland")), .SDcol = col_date]
