...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE,
                      fig.align = "center", fig.width = 10, fig.height = 10, dpi = 300)
#Constants
...
\@ref(fig:OverallAD) A boxplot shows the range of SWC in AshleyDene over 2 years. 

```{r OverallAD, fig.cap='(fig:OverallAD)'}
